...
function createList(){
    ...
    document.querySelector("#task").style.visibility="visible";
    ...
    document.querySelector("#b_icon").style.visibility="hidden";
    document.querySelector("#b_text").style.visibility="hidden";
...
function createCard(){
    ...
    title.addEventListener("click",()=>{
        document.querySelector("#task").style.visibility="hidden";
        document.querySelector("#list").style.visibility="hidden";
        document.querySelector("#additem").style.visibility="hidden";
        document.querySelector("#b_icon").style.visibility="visible";
        document.querySelector("#b_text").style.visibility="visible";
        ...
        document.querySelector("#b_icon").addEventListener("click",()=>{
        ...
        document.querySelector("#b_text").addEventListener("click",()=>{
            document.querySelector("#lists").style.justifyContent="space-around";
            document.querySelector("#task").style.visibility="visible";
            document.querySelector("#list").style.visibility="visible";
            document.querySelector("#createList").style.visibility="visible";
            ...
            document.querySelector("#b_text").style.visibility="hidden";
            document.querySelector("#heading").style.visibility="hidden";
            document.querySelector("#createList").style.fontSize="x-large";
            document.querySelector("#createList").style.marginLeft="0px";
            display(cards);
        });
    });
